function Footer() {
  return (
    <footer className="bg-veryDarkBlue text-white py-16 ">
      <div
        className="container mx-auto px-6 flex flex-col gap-y-16 items-center 
    md:flex-row md:justify-between"
      >
        {/* left */}
        <div className="flex flex-col gap-y-9 md:flex-row md:items-center md:gap-x-14">
          {/* icon */}
          ...
          {/* menu */}
          <ul
            className="flex flex-col items-center gap-y-8 text-lg text-grayishBlue 
        ...
        <div className="flex items-center gap-x-11">
          ...
          <a className="group" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
              <path
                className="group-hover:fill-softRed"
                fill="#FFF"
                fill-rule="evenodd"
          ...
          <a className="group" href="#">
            <svg
              className="scale-[1.22] cursor-pointer"
