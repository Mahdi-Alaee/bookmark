function Footer() {
  return (
    <footer
      className="bg-veryDarkBlue text-white py-16 flex flex-col gap-y-16 items-center 
    ...
    >
      ...
      <div>
        ...
        {/* menu */}
        <ul className="flex flex-col items-center gap-y-8 text-lg mt-9 text-grayishBlue">
