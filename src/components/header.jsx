      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        >
          <g fill="none" fillRule="evenodd">
            <path
              className={`${isMenuOpen ? "fill-white" : ""}`}
        ...
        {/* desktop menu */}
        <ul className="hidden gap-x-10 items-center md:flex">
          {/* item 1 */}
          <li>
            <a
          ...
          <li>
            <a
              className="bg-softRed block px-8 py-2 shadow-md rounded-lg uppercase text-white border-2 border-softRed hover:bg-transparent 
            hover:text-softRed"
              href="#"
            >
              Login
